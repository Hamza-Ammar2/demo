...
def main():
    ...
    print(
        "WARNING: mcPHASES is PhysioNet-restricted. Exporting/uploading derived client "
        "CSVs may violate your DUA — only push if you have cleared redistribution rights."
    )
