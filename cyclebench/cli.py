...
def cmd_train_tasks(args) -> int:
    """Train all registered TabularTask models (the model factory)."""
    from cyclebench.model.tasks import train_all_tasks
...
def main(argv=None) -> int:
    ...
    p_tasks = sub.add_parser("train-tasks", help="train model-factory tasks (e.g. PCOS)")
    p_tasks.set_defaults(func=cmd_train_tasks)
