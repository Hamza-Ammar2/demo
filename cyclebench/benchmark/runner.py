...
def evaluate() -> dict:
    ...
    summary = {
        ...
        "honesty_note": (
            "Cases are synthetic and co-designed with engine thresholds to test "
            "discrimination, leakage resistance, and safety copy — not clinical "
            "generalization. See docs/BENCHMARK.md."
        ),
        "n_cases": n,
