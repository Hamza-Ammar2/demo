...
| menopause_stage | SWAN ICPSR when `data/swan/swan_harmonized.csv` present; else synthetic SWAN-like cohort | Stage category from hormones + vasomotor/sleep/cycle features + age. |

## Metrics
See `results/model_hormonal_state.json` and `results/model_menopause_stage.json` after `make train-models`.
